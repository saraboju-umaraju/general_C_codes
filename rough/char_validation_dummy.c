...
# 5 "/usr/include/uma.h" 2 3 4
# 2 "_validation.c" 2
# 19 "_validation.c"
void call_invalid( char* );
...
start: printf("ENTER INTEGER\n");
  ...
  while ( *(buf + var++) ) {
    ...
    if ( ( ( *(buf + var) >= '0' && *(buf + var) <= '9' ) || ( *( buf + var ) =='\0' ) ) ) {

      printf("in character check\n");
      ...
      if ( space_flag == 0) {
        ...
        call_invalid("mis_placed_white_spaces");

    }

    else if ( ( *(buf + var) == '+' || *(buf + var) == '-' ) ) {

      printf("in sign check\n");

      if ( char_flag == 1 ) {

        call_invalid( "sign_mis_placed");
      ...
      if ( sign_flag > 1 ) {
        ...
        call_invalid( "invalid usage of sign" );
      ...
      if ( dot_count > 1 ) {
       ...
       call_invalid("mis_use_of_decimal_point");

      }
    }

    else if ( ( *(buf + var) == ' ' || *(buf + var) == '\t' || *(buf + var) == '\n' ) ) {

      printf("in space check\n");
      ...
      call_invalid( "alien_characters_in_integer_set" );
